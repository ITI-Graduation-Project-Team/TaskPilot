...
namespace TaskPilot.Services.Interfaces
{
    ...
    {
        Task<Result<UploadCompanyPolicyResponse>> IngestAsync(IngestCompanyPolicyRequest request, Func<CancellationToken, Task> saveChangesAsync, CancellationToken cancellationToken = default);
