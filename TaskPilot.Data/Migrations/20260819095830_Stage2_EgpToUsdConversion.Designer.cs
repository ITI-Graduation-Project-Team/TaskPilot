...
namespace TaskPilot.Data.Migrations
{
    ...
    [Migration("20260819095830_Stage2_EgpToUsdConversion")]
    partial class Stage2_EgpToUsdConversion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskPilot.Models.Entities.BillingSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("EgpPerUsdExchangeRate")
                        .HasColumnType("decimal(18,2)");

                    b.Property<DateTime?>("ExchangeRateUpdatedAt")
                        .HasColumnType("datetime2");

                    b.Property<Guid?>("ExchangeRateUpdatedByAdminId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("PricePerMillionTokens")
                        .HasColumnType("decimal(18,2)");

                    b.Property<DateTime?>("TokenPriceUpdatedAt")
                        .HasColumnType("datetime2")
                        .HasColumnName("UpdatedAt");

                    b.Property<Guid?>("TokenPriceUpdatedByAdminId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("UpdatedByAdminId");

                    b.HasKey("Id");

                    b.HasIndex("ExchangeRateUpdatedByAdminId");

                    b.HasIndex("TokenPriceUpdatedByAdminId");
            ...
            modelBuilder.Entity("TaskPilot.Models.Entities.Payment", b =>
                {
                    ...
                    b.Property<decimal>("ChargedAmountEgp")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("TaskPilot.Models.Entities.ProjectSetupState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("SkillsAttemptCount")
                        .HasColumnType("int");

                    b.Property<DateTime?>("SkillsCompletedAt")
                        .HasColumnType("datetime2");

                    b.Property<int>("SkillsCreated")
                        .HasColumnType("int");

                    b.Property<string>("SkillsError")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");

                    b.Property<string>("SkillsJobId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("SkillsStartedAt")
                        .HasColumnType("datetime2");

                    b.Property<int>("SkillsStatus")
                        .HasColumnType("int");

                    b.Property<int>("TasksCreated")
                        .HasColumnType("int");

                    b.Property<int>("TasksEnriched")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TechStackError")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");

                    b.Property<int>("TechStackStatus")
                        .HasColumnType("int");

                    b.Property<string>("TechStackSuggestionJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("UserStoriesCreated")
                        .HasColumnType("int");

                    b.Property<int>("WbsAttemptCount")
                        .HasColumnType("int");

                    b.Property<DateTime?>("WbsCompletedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("WbsError")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");

                    b.Property<string>("WbsJobId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("WbsStartedAt")
                        .HasColumnType("datetime2");

                    b.Property<int>("WbsStatus")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProjectSetupStates", (string)null);
                });
            ...
            modelBuilder.Entity("TaskPilot.Models.Entities.SprintBurnoutSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TaskPilot.Models.Entities.Wallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TaskPilot.Models.Entities.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TaskPilot.Models.Entities.BillingSettings", b =>
                {
                    b.HasOne("TaskPilot.Models.Entities.User", "ExchangeRateUpdatedByAdmin")
                        .WithMany()
                        .HasForeignKey("ExchangeRateUpdatedByAdminId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("TaskPilot.Models.Entities.User", "TokenPriceUpdatedByAdmin")
                        .WithMany()
                        .HasForeignKey("TokenPriceUpdatedByAdminId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("ExchangeRateUpdatedByAdmin");

                    b.Navigation("TokenPriceUpdatedByAdmin");
                });
            ...
            modelBuilder.Entity("TaskPilot.Models.Entities.ProjectSetupState", b =>
                {
                    b.HasOne("TaskPilot.Models.Entities.Project", "Project")
                        .WithOne("SetupState")
                        .HasForeignKey("TaskPilot.Models.Entities.ProjectSetupState", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TaskPilot.Models.Entities.WalletTransaction", b =>
                {
                    b.HasOne("TaskPilot.Models.Entities.Payment", "RelatedPayment")
                        .WithMany()
                        .HasForeignKey("RelatedPaymentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("TaskPilot.Models.Entities.User", "TriggeredByUser")
                        .WithMany()
                        .HasForeignKey("TriggeredByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("TaskPilot.Models.Entities.Wallet", "Wallet")
