...
public static class AssignmentErrors
{
    ...
    public static readonly Error SprintNotPlanned = new("SPRINT_NOT_PLANNED", ErrorType.Validation, "Task assignments can only be changed while the sprint is planned.");
    public static readonly Error CapacityExceeded = new("ASSIGNMENT_CAPACITY_EXCEEDED", ErrorType.Conflict, "This assignment would exceed the employee's sprint capacity.");
