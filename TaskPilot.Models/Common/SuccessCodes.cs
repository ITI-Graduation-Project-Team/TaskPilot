...
namespace TaskPilot.Models.Common
{
    public class SuccessCodes
    {
        ...
        public static class Calendar
        {
            ...
            public const string EventDeleted = "CALENDAR_EVENT_DELETED";
        ...
        {
            public const string Retrieved = "TELEMETRY_RETRIEVED_SUCCESS";
            public const string Logged = "TELEMETRY_LOGGED_SUCCESS";
        }
    }
}
